...
eigenvalues <- data.frame(var = propVar,
...
```{r}
## plot pca$x
ggplotly(fviz_pca_ind(pca, label="none", habillage=hosp_3months,
...
ggplotly(pcaPvalueHeatmap(pcs = pcs, demo = demo, method = "pearson"))
```
...
ggplotly(pcaPvalueHeatmap(pcs = pcs, demo = demo, method = "spearman"))
```
