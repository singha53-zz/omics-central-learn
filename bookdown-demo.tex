...
k genes from n genes Event of interest: \# of ways to get i genes from
Pathway A after drawing k genes = (\# of ways to select i genes from
Pathway A from a total of m genes in Pathway A, \(m \choose i \)) x (\#
of ways to get k-i from the remaining n-m genes not in Pathway A,
\(n-m \choose k-i \))
